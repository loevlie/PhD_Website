...
PUBLICATIONS = [
    {
        ...
        'year': 2026,
        'selected': True,
        'image': 'portfolio/images/chil_neuroimage_mil.png',
        'image_credit': '*Equal contribution',
        'links': [
            {'label': 'Paper', 'url': 'https://arxiv.org/abs/2604.26807'},
            {'label': 'Code', 'url': 'https://github.com/tufts-ml/neuroimage-classifiers'},
        ],
        'bibtex': """@misc{harvey2026multidatasetbenchmarkmultipleinstance,
      title={A Multi-Dataset Benchmark of Multiple Instance Learning for 3D Neuroimage Classification},
      ...
      note={Equal contribution: Harvey, Loevlie},
}""",
    },
    {
        'type': 'conference',
